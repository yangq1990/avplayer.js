...
class LevelController extends EventHandler {
 ...
 setLevelInternal(newLevel) {
  ...
  get startLevel() {
    ...
    if (this._startLevel === undefined) {
      let configStartLevel = this.AVPLAYER.config.startLevel;
  ...
  onError(data) {
    ...
    let details = data.details, hls = this.AVPLAYER, levelId, level, levelError = false;
  ...
  tick() {
    ...
    if (levelId !== undefined && this.canload) {
      ...
      this.AVPLAYER.trigger(Event.LEVEL_LOADING, {url: level.url[urlId], level: levelId, id: urlId});
    }
  }
